...
```sh
go get github.com/fischerling/librespot-golang/librespot
```
...
```sh
go get -u github.com/fischerling/librespot-golang
```
...
```sh
cd $GOPATH/src/github.com/fischerling/librespot-golang
